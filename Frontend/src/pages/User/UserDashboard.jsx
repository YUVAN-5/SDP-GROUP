...
import { Key, Pencil, UserIcon } from 'lucide-react';
...
const UserDashboard = () => {
  ...
  useEffect(() => {
    fetchUserData();
  }, []); // Add dependencies inside this array
        ...
        <div className='h-[40vh] w-[50vw] flex flex-row shadow-md shadow-orange-500/20'>
          <div className='w-1/2 h-full flex flex-col'>
            ...
            <div className='h-3/6 w-full flex justify-center items-center'>
              <UserIcon className='h-28 w-28 text-orange-500 border-4 border-orange-500/10 rounded-full shadow-md shadow-orange-500/40' />
            </div>
            ...
            <div className='h-screen w-screen flex absolute z-50 bg-gray-500/60 justify-center items-center top-0 left-0'>
              <form className='h-[45vh] w-[30vw] flex flex-col shadow-md shadow-orange-500/20 bg-white rounded-sm'>
                <div className='h-5/6 w-full flex flex-col justify-center items-center p-2 gap-4'>
                  <input type="text" id="name" placeholder='Name' value={userdata.name} className='bg-orange-100/30 outline-none border-2 border-transparent focus:border-b-2 focus:border-b-orange-300 rounded-sm w-[80%] text-black placeholder:text-black p-2 shadow-sm' required onChange={handleChange} />
                  <input type="email" id="email" placeholder='Email' value={userdata.email} className='bg-red-100/30 outline-none border-2 border-transparent focus:border-b-2 focus:border-b-orange-300 rounded-sm w-[80%] text-black placeholder:text-black p-2 shadow-sm cursor-not-allowed' required onChange={handleChange} disabled />
                  <input type="number" id="phone" placeholder='Phone' value={userdata.phone} className='bg-orange-100/30 outline-none border-2 border-transparent focus:border-b-2 focus:border-b-orange-300 rounded-sm w-[80%] text-black placeholder:text-black p-2 shadow-sm' required onChange={handleChange} />
          ...
          <>
            <div className='h-screen w-screen flex absolute z-50 bg-gray-500/60 justify-center items-center top-0 left-0'>
              <div className='h-[45vh] w-[30vw] flex flex-col shadow-md shadow-orange-500/20 bg-white rounded-sm'>
                <div className='h-5/6 w-full flex flex-col justify-center items-center p-2 gap-4'>
                  <input type="text" placeholder='Old Password' className='bg-orange-100/30 outline-none border-2 border-transparent focus:border-b-2 focus:border-b-orange-300 rounded-sm w-[80%] text-black placeholder:text-black p-2 shadow-sm' />
                  <input type="text" placeholder='New Password' className='bg-orange-100/30 outline-none border-2 border-transparent focus:border-b-2 focus:border-b-orange-300 rounded-sm w-[80%] text-black placeholder:text-black p-2 shadow-sm' />
                  <input type="text" placeholder='Confirm Password' className='bg-orange-100/30 outline-none border-2 border-transparent focus:border-b-2 focus:border-b-orange-300 rounded-sm w-[80%] text-black placeholder:text-black p-2 shadow-sm' />
                </div>
                <div className='h-1/6 w-full flex flex-row justify-center items-center'>
